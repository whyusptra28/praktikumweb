...
$penduduk->nik_kk}}|{{$penduduk->nama_kk }}</option>
                        ...
                        <label class="form-label col-sm-2">Jumlah
                            Dana</label>
                        <div class="col-sm-4">
                            <input type="text" name="dana" placeholder="Jumlah Dana" class="form-control" value="{{ 
old('dana') }}" required>
                        </div>
                    </div>
                    <div class="form-group row">
...
2">Keterangan</label>
                        <div class="col-sm-4">
                            <input type="text" name="keterangan" placeholder="Keterangan" class="form-control" value="{{ 
old('keterangan') }}" required>
                        </div>
                    </div>
